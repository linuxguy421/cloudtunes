...
error_reporting(0);
$m = new Memcached();
$m->addServer('192.168.39.212', 31211) or die ("Cannot connect to memcached!");
$json = file_get_contents("http://192.168.39.212:30420/status-json.xsl");
...
$string = file_get_contents("http://192.168.39.212:30420/status-json.xsl");
